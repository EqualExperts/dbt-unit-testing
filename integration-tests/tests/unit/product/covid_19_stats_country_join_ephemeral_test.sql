...
{% call dbt_unit_testing.test ('covid19_stats_ephemeral') %}
  {% call dbt_unit_testing.mock_ref ('covid19_cases_per_day_ephemeral') %}
...
{% call dbt_unit_testing.test ('covid19_stats_ephemeral', 'test csv format') %}
  {% call dbt_unit_testing.mock_ref ('covid19_cases_per_day_ephemeral', {"input_format": "csv"}) %}
