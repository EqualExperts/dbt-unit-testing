...
{% call dbt_unit_testing.test('covid19_cases_per_day_ephemeral', 'empty payload') %}
...
{% call dbt_unit_testing.test('covid19_cases_per_day_ephemeral', 'extracting cases from payload') %}
  {% call dbt_unit_testing.mock_source('dbt_unit_testing', 'covid19_stg') %}
...
{% call dbt_unit_testing.test('covid19_cases_per_day_ephemeral', 'extracting country id') %}
  {% call dbt_unit_testing.mock_source('dbt_unit_testing', 'covid19_stg') %}
